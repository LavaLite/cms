<!-- Start partials /themes/public-lavalite/partials/footer.blade.php -->
		<footer>
					...
					<div class="row">
						...
						<div class="column logo col-md-4 text-center">
							<div class="logo-content">
								<img class="animate_fade_in" src="{{Theme::asset()->url('images/logo_footer.png')}}" width="200" alt="" />
...
<!-- End partials /themes/public-lavalite/partials/footer.blade.php -->